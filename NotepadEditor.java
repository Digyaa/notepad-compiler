...
public class NotepadEditor {
	...
	JMenuItem wordWrapItem,fontItem,fontSizeItem,fontType;
	...
	public void createFileMenuItem()
	{
		...
		newWindowItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				NotepadEditor g2 = new NotepadEditor() ;
	...
	public void createFormatItem()
	{
	    ...
	    italics = new JMenuItem("Italics");
         italics.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				textArea.setFont(new Font(fontStyle, Font.ITALIC ,fontSize) );
				
			}
		});
	    
	    
		fontType.add(italics);
		 ...
		 bold.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				textArea.setFont(new Font(fontStyle, Font.BOLD ,fontSize) );
				
			}
		});
		fontType.add(bold);
		
		both= new JMenuItem("both");
		both.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
	
				textArea.setFont(new Font(fontStyle,Font.BOLD | Font.ITALIC,fontSize));
			}
		});
		fontType.add(both);
	...
	public void setLanguage(String lang)
	{
		...
		case "Java":
		{
			path = "B:\\digyaa\\Internship\\Notepad\\src\\req\\javaformat" ;
		}
			
			break;
		case "C":
		{
			path = "B:\\digyaa\\Internship\\Notepad\\src\\fetchdoc\\cformat.txt" ;
		}
			break ;
		case "C++" :
		{
			path = "B:\\digyaa\\Internship\\Notepad\\src\\fetchdoc\\cppformat.txt" ;
		}
			break ;
		case "HTML":
		{
			path = "B:\\digyaa\\Internship\\Notepad\\src\\fetchdoc\\htmlformat.txt" ;
		}
			break ;
		case "Python":
		{
			path = "B:\\digyaa\\Internship\\Notepad\\src\\fetchdoc\\pythonformat.txt" ;
		}
			break ;
		}
